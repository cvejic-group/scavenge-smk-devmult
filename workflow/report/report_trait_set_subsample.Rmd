...
if (interactive()) { ## fake data for testing
  ...
  snakemake <- Snakemake(
    input=list(se="results/se/subsamples/se_sample300_rng20241104.Rds",
               csv_trait_set="results/trs/df_trs_scavenge_yu_2022_knn30_bg200_sample300_rng20241104.csv.gz"),
    output=list("results/reports/trs/report_scavenge_yu_2022_knn30_bg200_sample300_rng20241104.html"),
